# -*- coding: utf-8 -*-
#
# dilium documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'dilium.tex', u'dilium Documentation',
...
man_pages = [
    (master_doc, 'dilium', u'dilium Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dilium', u'dilium Documentation',
     author, 'dilium', 'One line description of project.',
     'Miscellaneous'),
]
